...
echo "=== PRUEBA DE REPORTES CON AUTENTICACIÓN ===\n\n";
...
if (!$admin) {
    echo "❌ No se encontró ningún admin para las pruebas\n";
    exit(1);
}
...
echo "   - payment-reports.view: " . ($admin->hasPermission('payment-reports.view') ? '✅' : '❌') . "\n";
echo "   - payment-reports.generate: " . ($admin->hasPermission('payment-reports.generate') ? '✅' : '❌') . "\n";
