...
echo "=== PRUEBA CON TOKEN CSRF REAL ===\n\n";

try {
    // Primero obtener un token CSRF real
    ...
    curl_setopt($ch, CURLOPT_COOKIEJAR, __DIR__ . '/cookies.txt'); // Guardar cookies
    curl_setopt($ch, CURLOPT_COOKIEFILE, __DIR__ . '/cookies.txt'); // Usar cookies
    ...
    // Ahora probar la petición PDF con el token real
    ...
    echo "2. Probando petición PDF con token CSRF real...\n";
    echo "  - URL: {$url}\n";
    ...
    curl_setopt($ch, CURLOPT_HEADER, true);
    curl_setopt($ch, CURLOPT_COOKIEFILE, __DIR__ . '/cookies.txt'); // Usar cookies de la sesión
    ...
    echo "3. Resultado de la petición:\n";
